...
export class LiteYTEmbed extends HTMLElement {
    ...
    async testPosterImage() {
        setTimeout((() => {
            ...
            e.fetchPriority = "high", e.referrerPolicy = "origin", e.src = t, e.onload = async t => {
                ...
                this.domRefImg.webp.srcset = i, this.domRefImg.fallback.loading = "eager", this.domRefImg.fallback.src = i
            }
        }), 100)
    }
    initIntersectionObserver() {
        if (new IntersectionObserver(((t, e) => {
                t.forEach((t => {
                    t.isIntersecting && !this.isIframeLoaded && (LiteYTEmbed.warmConnections(this), this.addIframe(!0), e.unobserve(this))
                }))
            }), {
                root: null,
                rootMargin: "0px",
