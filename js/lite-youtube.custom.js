...
export class LiteYTEmbed extends HTMLElement {
    ...
    initImagePlaceholder() {
        this.testPosterImage(), this.domRefImg.webp.setAttribute("aria-label", `${this.videoPlay}: ${this.videoTitle}`), this.domRefImg?.webp?.setAttribute("alt", `${this.videoPlay}: ${this.videoTitle}`)
    }
    async testPosterImage() {
        setTimeout((() => {
            ...
            e.fetchPriority = "high", e.referrerPolicy = "origin", e.src = t, e.onload = async t => {
                ...
                this.domRefImg.webp.srcset = i, this.domRefImg.webp.loading = "eager", this.domRefImg.webp.src = i
            }
        }), 100)
    }
